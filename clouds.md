...
Here, 
M
M is a matrix of musical coefficients (defining notes, octaves, rhythms), and 
S
p
S 
p
​
  is a binary activation matrix determined by the cloud cover in each image quadrant 
p
p. The Hadamard product (
⊙
